...
case_order_by_sort_key_can_differ_from_projection() {
  local sql
...
case_order_by_invalid_column_reports_invalid_query() {
  local sql
...
case_order_by_error_does_not_stop_next_statement() {
  local sql
  sql=$'SELECT name FROM users ORDER BY email;\nINSERT INTO users (name, age, major) VALUES (\'박지호\', 23, \'물리학\');\nSELECT name FROM users;\n'
  local expected_out
  expected_out=$'name\n박지호\n'
  local expected_err
  expected_err=$'ERROR: invalid query\n'
...
run_case "order_by_single_column_default_ascending" case_order_by_single_column_default_ascending
run_case "order_by_sort_key_can_differ_from_projection" case_order_by_sort_key_can_differ_from_projection
run_case "order_by_invalid_column_reports_invalid_query" case_order_by_invalid_column_reports_invalid_query
run_case "order_by_error_does_not_stop_next_statement" case_order_by_error_does_not_stop_next_statement
